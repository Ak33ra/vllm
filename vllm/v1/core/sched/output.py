...
class SchedulerOutput:
    ...
    # Number of unscheduled requests remaining in the waiting queues after this
    # scheduling step selected the current batch.
    num_waiting_reqs_after_schedule: int = 0
